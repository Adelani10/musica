...
export default function TopCharts ({item}) {
    return (
            <Link to={`/home/${item.path}`} key={item.id} className="flex justify-between md:items-center bg-[#1A1E1F] md:px-2 lg:px-8 px-4 py-3 md:py-2 min-w-[85%] md:min-w-0 md:w-full rounded-xl items-start  ">
