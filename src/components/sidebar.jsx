...
export default function Sidebar () {
    ...
    return (
        <>
            ...
            <aside 
                className={` ${isShown ? "translate-x-[]" : ""} flex flex-col md:sticky fixed md:hidden p-12 space-y-16 pt-6 bottom-0 left-0 top-0 h-full w-[85%]  bg-[#1A1E1F] duration-700 ease-in-out -translate-x-full z-50`}>
